...
**Status:** library source only. `@telecrypt-io/storage@0.2.1` is the current public release,
published from this repository's protected `v0.2.1` tag with NPM Trusted Publishing/OIDC
provenance. The older `0.1.3` release is the immutable legacy combined library-and-CLI package.

## Install

```bash
npm install @telecrypt-io/storage@0.2.1
```
