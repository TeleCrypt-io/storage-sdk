...
**Status:** library source only. `@telecrypt-io/storage@0.2.0` is the current public release,
published from this repository's protected `v0.2.0` tag with NPM Trusted Publishing/OIDC
